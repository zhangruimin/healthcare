...
public class PacketStreamBuilder {
    ...
    byte[] digitData = {67, 69, 98, 36, 60, 18, 4, 60};
    byte[] waveTypes = {7};
    ...
    byte[] RESPwaveData = {(byte)0x0d, (byte)0x0d, (byte)0x0d, (byte)0x0d, (byte)0x0d, (byte)0x0d, (byte)0x0d, (byte)0x0d, (byte)0xaf};
    byte[] waveData;
    ...
    public PacketStreamBuilder() {
        waveData = ArrayUtils.addAll(ECGwaveData, BOwaveData);
        waveData = ArrayUtils.addAll(waveData, RESPwaveData);
    }
